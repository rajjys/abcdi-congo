...
// It takes in the index and news data as props and displays the news item with an image, title, headline, author, and date.
// It also includes a link to the news item page.
...
return (
            ...
            className={`flex flex-col ${ isEven? "sm:flex-row" : "sm:flex-row-reverse"} justify-between rounded shadow-md dark:shadow-white/20 md:shadow-none mb-4 sm:mb-6 md:mb-8 lg:mb-12 group-hover:opacity-100 transition-opacity duration-300`}>
                    <div className="flex-1 group-hover:opacity-100 transition-opacity duration-300">
